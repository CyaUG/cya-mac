...
@class CommunityToolkit_Maui_Core_Views_MauiMediaElement;
...
@class ZXing_Net_Maui_PreviewView;
@class ZXing_Net_Maui_CaptureDelegate;
...
@interface Youth_CustomAnnotation : MKPointAnnotation {
}
	-(void) release;
	-(id) retain;
	-(GCHandle) xamarinGetGCHandle;
...
@interface CommunityToolkit_Maui_Core_Views_MauiMediaElement : UIView {
}
	-(void) release;
	-(id) retain;
	-(GCHandle) xamarinGetGCHandle;
...
@interface Microsoft_Maui_Controls_Compatibility_Platform_iOS_ItemsViewDelegator_2 : NSObject<UICollectionViewDelegate, UICollectionViewDelegateFlowLayout> {
}
	-(void) release;
	-(id) retain;
	-(GCHandle) xamarinGetGCHandle;
...
@interface Microsoft_Maui_Controls_Compatibility_Platform_iOS_CarouselViewDelegator : Microsoft_Maui_Controls_Compatibility_Platform_iOS_ItemsViewDelegator_2<UICollectionViewDelegate, UICollectionViewDelegateFlowLayout> {
}
	-(void) scrollViewDidScroll:(UIScrollView *)p0;
...
@interface Microsoft_Maui_Controls_Compatibility_Platform_iOS_SelectableItemsViewDelegator_2 : Microsoft_Maui_Controls_Compatibility_Platform_iOS_ItemsViewDelegator_2<UICollectionViewDelegate, UICollectionViewDelegateFlowLayout> {
}
	-(void) collectionView:(UICollectionView *)p0 didSelectItemAtIndexPath:(NSIndexPath *)p1;
	-(void) collectionView:(UICollectionView *)p0 didDeselectItemAtIndexPath:(NSIndexPath *)p1;
@end

@interface Microsoft_Maui_Controls_Compatibility_Platform_iOS_GroupableItemsViewDelegator_2 : Microsoft_Maui_Controls_Compatibility_Platform_iOS_SelectableItemsViewDelegator_2<UICollectionViewDelegate, UICollectionViewDelegateFlowLayout> {
}
